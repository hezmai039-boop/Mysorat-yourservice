...
- كتالوج خدمات حكومية شامل (44 خدمة عبر 12 تصنيفاً) يغطي المواطن والمقيم
  والزائر والأعمال: الهوية والأحوال المدنية، الإقامة والجوازات، تأشيرات
  الزيارة والسياحة، المرور والمركبات، الصحة، التعليم، الإسكان والعقار،
  البلدية والمرافق، العدل والتوثيق، الأعمال والاستثمار، المالية، والموارد
  البشرية — مع تصفية الصفحة الرئيسية حسب الفئة (مواطن/مقيم/زائر/أعمال).
...
- استعادة كلمة المرور عبر رابط بريد إلكتروني صالح لمرة واحدة ولمدة 30 دقيقة
  (`/forgot-password`، `/reset-password`) — يعمل مباشرة عبر Resend عند ضبط
  `RESEND_API_KEY`، وإلا يُطبع الرابط في سجلات الخادم للتطوير المحلي.
...
- **رسوم ومدد كتالوج الخدمات**: الأرقام في `backend/src/services/seedData.ts`
  (الرسوم التقديرية وعدد الأيام) قيم استرشادية لعرض المنصة، وليست تسعيرة رسمية
  حية من الجهات الحكومية. راجعها وحدّثها لتطابق التسعيرة الفعلية لكل جهة قبل
  الاعتماد عليها في الفوترة الحقيقية.
